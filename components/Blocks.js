...
const Blocks = () => {
  return (
    <div className='flex flex-col mt-10'>
      <div className='flex justify-evenly shadow-lg	 overflow-hidden flex-col lg:flex-row w-full items-center self-center lg:w-11/12 font-sans py-10 lg:py-4 px-4 my-6 mx-3'>
      ...
      <div className='flex justify-evenly shadow-lg	 overflow-hidden flex-col w-full items-center self-center lg:w-11/12 font-sans  px-4 my-6 mx-3 py-10 lg:py-0 lg:flex-row-reverse'>
        <div className='lg:w-2/5 w-full'>
      ...
      <div className='flex justify-evenly shadow-lg	 overflow-hidden flex-col lg:flex-row w-full items-center self-center lg:w-11/12 font-sans  py-10 lg:py-0  px-4 my-6 mx-3'>
        <div className='lg:w-2/5 w-full'>
